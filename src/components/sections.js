...
const Testimonials = (props) => (
  <div className="Testimonials">
    <blockquote>
    <p className="quote">It&#39;s like being Daredevil... on crack.</p>
    <p className="name">Marcus, 24</p>
    </blockquote>
    <blockquote>
    <p className="quote">It is fun to play, it is scary and it has lots of potential.</p>
    <p className="name">Linn, 23</p>
    </blockquote>
    <blockquote>
    <p className="quote">You were supposed to talk but I forgot.</p>
    ...
    <blockquote>
    <p className="quote">It was fun because it was dark and you could see trough walls.</p>
    <p className="name">Isabel, 23</p>
    </blockquote>
    <blockquote>
    <p className="quote">It was entertaining as a thriller because you were both harmless and vulnerable. Escape was the only option. You are, quite literally, a chicken.</p>
    <p className="name">Marcus, 23</p>
    </blockquote>
    <blockquote>
    <p className="quote">It was scary because you get so immersed. I WAS THE CHICKEN.</p>
    <p className="name">Simone, 25</p>
    </blockquote>
    <blockquote>
    <p className="quote">Sound is how you see, but also how you get noticed. My strategy? Keep quiet.</p>
    <p className="name">Emma, 23</p>
    </blockquote>
    <blockquote>
    <p className="quote">I could imagine this becoming commercially viable. I would gladly pay a couple bucks for this!</p>
